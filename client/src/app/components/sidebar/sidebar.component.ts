      ...
      <div class="flex-grow overflow-y-auto px-4 custom-scrollbar">
        ...
        <div class="mb-6" *ngIf="auth.role() === 'employer'">
          ...
          <nav class="space-y-1">
            ...
            <a routerLink="/employer-profile" routerLinkActive="bg-brand-50 text-brand-800 font-semibold shadow-[inset_2px_0_0_0_var(--color-brand-600)]" class="flex items-center gap-3 pl-3 pr-3 py-2.5 rounded-r-lg text-stone-600 hover:bg-stone-50 hover:translate-x-0.5 transition-all text-sm">
