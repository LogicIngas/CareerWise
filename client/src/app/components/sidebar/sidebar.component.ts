      ...
      <div class="flex-grow overflow-y-auto px-4 custom-scrollbar">
        <div class="mb-6">
          ...
          <nav class="space-y-1">
            ...
            <a routerLink="/messages" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-50 transition-all text-sm">
            ...
            <a routerLink="/profile" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 hover:bg-gray-50 transition-all text-sm">
